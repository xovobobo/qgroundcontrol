...
Q_DECLARE_LOGGING_CATEGORY(SpiralComplexItemLog)

class PlanMasterController;
class MissionItem;

class SpiralComplexItem : public TransectStyleComplexItem
{
    Q_OBJECT
...
public:
    ...
    QString         mapVisualQML        (void) const final { return QStringLiteral("SpiralMapVisual.qml"); }
    ...
    QString             commandDescription  (void) const final { return tr("Spiral"); }
    QString             commandName         (void) const final { return tr("Spiral"); }
    ...
    static constexpr const char* jsonComplexItemTypeValue =   "spiral";
